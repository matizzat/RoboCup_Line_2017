...
#define N_INT_IZQ 1250
#define N_INT_DER 1350//980
#define N_INT_DEL 950
#define N_INT_TRAS 510
#define EXT_INT_I 450//230
#define EXT_INT_D 660
...
int main(){
  ...
  while(true){
    ...
    (s_e_der < 900 || s_e_izq < 800)) ||
    ((RAZON_RGB_I || RAZON_RGB_D) && tiempo > 500)) {
      led_g = !RAZON_RGB_I;
      led_r = !RAZON_RGB_D;
      motores(-0.01,-0.01);
      wait(0.1f);
    ...
    /*if(((s_izq < N_INT_IZQ && s_der < N_INT_DER && s_tras < N_INT_TRAS && s_del < N_INT_DEL) ||
    (s_izq < N_INT_IZQ && s_del < N_INT_DEL && s_tras < N_INT_TRAS && s_e_izq < EXT_INT_I) ||
    (s_der < N_INT_DER && s_del < N_INT_DEL && s_tras < N_INT_TRAS && s_e_der < EXT_INT_D)) ||
    ((RAZON_RGB_I || RAZON_RGB_D) && tiempo > 500)) {
      led_g = !RAZON_RGB_I;
      led_r = !RAZON_RGB_D;
      motores(-0.01,-0.01);
    ...
    if(fabs(angle[0]) < 68.5f && angle[0] < 0){
      motores(0.0,0.0);
      wait(0.1f);
      led_g = 0;
      led_r = 0;
